...
def get_asesorias(asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def get_asesoria(asesoria_id: int, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def get_asesorias_usuario(usuario_uid: str, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def get_asesorias_programador(programador_uid: str, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def get_asesorias_pendientes(programador_uid: str, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def create_asesoria(asesoria: schemas.AsesoriaCreate, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def update_asesoria(asesoria_id: int, asesoria: schemas.AsesoriaUpdate, 
...
def delete_asesoria(asesoria_id: int, asesoria_service: service.AsesoriaService = Depends(get_asesoria_service)):
...
def get_ausencias(ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
...
def get_ausencia(ausencia_id: int, ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
...
def get_ausencias_programador(programador_uid: str, ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
...
def get_ausencias_por_fecha(programador_uid: str, fecha: str, 
...
def create_ausencia(ausencia: schemas.AusenciaCreate, ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
...
def update_ausencia(ausencia_id: int, ausencia: schemas.AusenciaUpdate,
                   ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
...
def delete_ausencia(ausencia_id: int, ausencia_service: service.AusenciaService = Depends(get_ausencia_service)):
