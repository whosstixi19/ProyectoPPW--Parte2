  ...
  simularEnvioCorreo(
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        console.log('%c✅ Solicitud enviada por Gmail y WhatsApp', 'color: #27ae60; font-weight: bold; font-size: 14px;');
        ...
        console.error('%c❌ Error al enviar notificaciones', 'color: #e74c3c; font-weight: bold;');
        console.error(error);
  ...
  enviarRespuestaAsesoria(
    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        console.log(`%c✅ Respuesta de ${estadoTexto} enviada al usuario por Gmail y WhatsApp`, 'color: #27ae60; font-weight: bold; font-size: 14px;');
